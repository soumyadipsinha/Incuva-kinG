...
export default function AlbumPrintingExplore() {
  const albumDesigns = [
    {
      id: 1,
      ...
      description: "Premium wedding photo album with elegant design and high-quality printing",
    ...
    },
    {
      ...
      style: "Modern",
      price: 1999,
      image: "/assets/canverastylealbum2.png",
      description: "Professional event photography album with modern layout",
      tags: ["Events", "Modern", "Professional"],
      rating: 4.8,
      downloads: 890
    },
    {
      ...
      style: "Classic",
      price: 1599,
      image: "/assets/canverastylealbum3.png",
      description: "Beautiful family portrait album with classic design elements",
      tags: ["Family", "Classic", "Portrait"],
      rating: 4.7,
      downloads: 650
    },
    {
      ...
      style: "Professional",
      price: 2499,
      image: "/assets/canverastylealbum4.png",
      description: "Professional corporate event album for business documentation",
    ...
    },
    {
      ...
      style: "Creative",
      price: 1799,
      image: "/assets/canverastylealbum5.png",
      description: "Creative travel photo album with vibrant layouts",
      tags: ["Travel", "Creative", "Vibrant"],
      rating: 4.9,
      downloads: 780
    },
    {
      ...
      style: "Cute",
      price: 1299,
      image: "/assets/canverastylealbum6.png",
      description: "Adorable baby photo album with cute design elements",
      tags: ["Baby", "Cute", "Adorable"],
      rating: 4.8,
      downloads: 950
    }
  ];

  const categories = ["All", "Wedding", "Events", "Family", "Corporate", "Travel", "Baby"];
  const styles = ["All Styles", "Luxury", "Modern", "Classic", "Professional", "Creative", "Cute"];
    ...
    <main className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="animate-fade-in-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-2">
                Album Printing <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Designs</span>
              </h1>
              <p className="text-lg text-muted-foreground animate-fade-in-up animation-delay-200">
                Premium photo album designs for all special occasions
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <Input placeholder="Search albums..." className="w-full sm:w-64" />
