...
export default function PosterFlyerDesignExplore() {
  const posterDesigns = [
    {
      id: 1,
      title: "Event Poster",
      ...
      description: "Modern event poster design with eye-catching visuals and typography",
      tags: ["Event", "Modern", "Typography"],
      rating: 4.9,
      downloads: 2800
    },
    {
      ...
      description: "Bold marketing flyer design for promotional campaigns",
    ...
    },
    {
      ...
      description: "Vibrant festival poster design with colorful elements",
      tags: ["Festival", "Vibrant", "Colorful"],
      rating: 4.7,
      downloads: 1900
    },
    {
      ...
      description: "Appetizing restaurant menu design with food photography",
    ...
    },
    {
      ...
      description: "Dynamic concert poster design for music events",
      tags: ["Concert", "Music", "Dynamic"],
      rating: 4.9,
      downloads: 1200
    },
    {
      ...
      description: "Attention-grabbing sale flyer design for retail promotions",
      tags: ["Sale", "Retail", "Promotion"],
      rating: 4.6,
      downloads: 2500
    }
  ];

  const categories = ["All", "Events", "Marketing", "Festivals", "Food & Beverage", "Entertainment", "Retail"];
  const styles = ["All Styles", "Modern", "Bold", "Vibrant", "Appetizing", "Dynamic", "Attention-grabbing"];
    ...
    <main className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="animate-fade-in-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-2">
                Poster & Flyer <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Designs</span>
              </h1>
              <p className="text-lg text-muted-foreground animate-fade-in-up animation-delay-200">
                Creative poster and flyer designs for all occasions
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <Input placeholder="Search posters..." className="w-full sm:w-64" />
