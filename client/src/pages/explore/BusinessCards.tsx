    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="border-b bg-secondary/30">
        <div className="mx-auto max-w-7xl px-4 py-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-primary">Business Card Designs</h1>
              <p className="text-muted-foreground">Professional business card templates for every industry</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-4">
          ...
          <Input placeholder="Search cards..." className="w-64" />
