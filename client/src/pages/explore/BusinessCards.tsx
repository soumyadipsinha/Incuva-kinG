...
export default function BusinessCardsExplore() {
  const cardDesigns = [
    {
      id: 1,
      ...
      description: "Elegant and professional business card design",
    ...
    },
    {
      ...
      tags: ["Creative", "Agency", "Modern"],
      rating: 4.8,
      downloads: 3800
    },
    {
      id: 3,
      title: "Medical Practice Card",
      category: "Healthcare",
      style: "Clean",
      price: 119,
      image: "https://images.unsplash.com/photo-1505236858219-8359eb29e329?auto=format&fit=crop&w=600&q=60",
      description: "Clean and trustworthy medical business card",
    ...
    },
    {
      ...
      description: "Inviting and warm design for restaurants",
    ...
    },
    {
      ...
      description: "Sleek and minimalist tech business card",
      tags: ["Tech", "Startup", "Minimalist"],
      rating: 4.9,
      downloads: 4500
    },
    {
      ...
      description: "Energetic and dynamic fitness business card",
  ...
  const categories = ["All", "Corporate", "Creative", "Healthcare", "Food & Beverage", "Technology", "Health & Fitness"];
  const styles = ["All Styles", "Professional", "Modern", "Clean", "Warm", "Minimalist", "Dynamic"];
    ...
    <main className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="animate-fade-in-up">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-primary mb-2 animate-fade-in-up">
                Business Card <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Designs</span>
              </h1>
              <p className="text-lg text-muted-foreground animate-fade-in-up animation-delay-200">
                Professional business card templates for every industry
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <Input placeholder="Search cards..." className="w-full sm:w-64" />
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {cardDesigns.map((design, index) => (
            <Card key={design.id} className={`group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 rounded-2xl animate-fade-in-up animation-delay-${(index + 1) * 200}`}>
              <div className="aspect-[3/2] w-full overflow-hidden bg-white relative">
                <img
                  src={design.image}
                  alt={design.title}
                  className="h-full w-full object-contain p-4 transition-transform group-hover:scale-110 duration-500"
                  loading="lazy"
                />
