...
export default function CorporateBrandingExplore() {
  const brandingDesigns = [
    {
      ...
      description: "Complete brand identity package including logo, business cards, and letterheads",
      tags: ["Brand", "Identity", "Complete"],
      rating: 4.9,
      downloads: 800
    },
    {
      ...
      description: "Modern corporate logo design with multiple concepts and revisions",
      tags: ["Logo", "Corporate", "Modern"],
      rating: 4.8,
      downloads: 1200
    },
    {
      ...
      description: "Elegant business stationery design including cards and letterheads",
      tags: ["Stationery", "Business", "Elegant"],
      rating: 4.7,
      downloads: 900
    },
    {
      ...
      description: "Comprehensive brand guidelines document with usage rules",
      tags: ["Guidelines", "Brand", "Comprehensive"],
      rating: 4.9,
      downloads: 600
    },
    {
      ...
      description: "Cohesive marketing materials design for brand consistency",
      tags: ["Marketing", "Materials", "Cohesive"],
      rating: 4.8,
      downloads: 700
    },
    {
      ...
      description: "Contemporary digital branding for online presence",
      tags: ["Digital", "Online", "Contemporary"],
      rating: 4.6,
      downloads: 1000
    }
  ];

  const categories = ["All", "Brand Identity", "Logo Design", "Stationery", "Guidelines", "Marketing", "Digital"];
  const styles = ["All Styles", "Professional", "Modern", "Elegant", "Comprehensive", "Cohesive", "Contemporary"];
    ...
    <main className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="animate-fade-in-up">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-primary mb-2 animate-fade-in-up">
                Corporate <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Branding</span>
              </h1>
              <p className="text-lg text-muted-foreground animate-fade-in-up animation-delay-200">
                Professional corporate branding solutions for businesses
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <Input placeholder="Search branding..." className="w-full sm:w-64" />
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {brandingDesigns.map((design, index) => (
