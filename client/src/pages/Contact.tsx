        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 px-4">
              Ready to start your project? Get in touch with our design and
              printing experts. We're here to bring your vision to life.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Choose your preferred way to connect with us for your design and
              printing needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <Card className="shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                <div className="w-16 h-16 bg-amber-100 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-transform duration-300 group-hover:scale-105">
              ...
              <CardContent className="text-center">
                <div className="space-y-4 mb-6">
                  <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4">
                    <div className="text-lg font-semibold text-primary break-all">
                      services@kingtechs.in
                    </div>
                  </div>
...
[Your Contact Number]`);
                    window.open(
                      `mailto:soumyadipsinha273@gmail.com?subject=${subject}&body=${body}`
                    );
                  }}
                >
            ...
            <Card className="shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                <div className="w-16 h-16 bg-cyan-100 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-transform duration-300 group-hover:scale-105">
            ...
            <Card className="shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-transform duration-300 group-hover:scale-105">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Follow these simple steps to place your order and get your design
              project started.
            </p>
          </div>
                ...
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Select from our design and printing services
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
              ...
              <Card className="shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-xl">Order & Confirm</CardTitle>
                      <CardDescription>
                        We'll process your order and confirm details
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Copy and customize this template for your order
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-gray-100 p-6 rounded-2xl font-mono text-sm">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      Design Order - [Your Service Type]
                    </div>
                    <div className="border-t pt-4">
                      ...
                      <br />
                      <p>
                        <strong>Service Required:</strong> [Logo Design /
                        Business Cards / Banner Design / etc.]
                      </p>
                      <p>
                        <strong>Quantity:</strong> [Number of items]
                      </p>
                      <p>
                        <strong>Business Name:</strong> [Your Company Name]
                      </p>
                      <p>
                        <strong>Industry:</strong> [Your Business Type]
                      </p>
                      <br />
                      <p>
                      ...
                      <br />
                      <p>
                        <strong>Timeline:</strong> [When you need it delivered]
                      </p>
                      <p>
                        <strong>Budget:</strong> [Your budget range]
                      </p>
                      <br />
                      <p>
                        Please send me a detailed quote and timeline for this
                        project.
                      </p>
                      <br />
                      <p>Thank you!</p>
      ...
      <section className="py-20 bg-transparent">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We deliver exceptional design and printing services with unmatched
              quality and speed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Professional designs and printing that exceed expectations.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Experienced designers and printers with creative expertise.
              </p>
            </div>
